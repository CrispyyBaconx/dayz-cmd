...
pub const HIGHLIGHT: Style = Style::new().fg(Color::Yellow).add_modifier(Modifier::BOLD);
...
pub const SEARCH_INPUT: Style = Style::new().fg(Color::White).add_modifier(Modifier::BOLD);
